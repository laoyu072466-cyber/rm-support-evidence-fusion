...
CONFIG_PATH = (
    ROOT
    / "configs/fresh_math_2026_qwen3_8b_thinking_smoke_v2.json"
)
PARTS_DIR = (
    ROOT
    / "outputs/fresh_math_2026/qwen3_8b_thinking_smoke_v2_parts"
)
OUTPUT_PATH = (
    ROOT
    / "outputs/fresh_math_2026/"
    "qwen3_8b_thinking_smoke_v2_candidates.jsonl"
)
MANIFEST_PATH = (
    ROOT
    / "data/manifests/"
    "fresh_math_2026_qwen3_8b_thinking_smoke_v2.json"
)
...
def main():
    ...
    print()
    print("===== Track B Thinking v2 冒烟完成 =====")
    print(
        json.dumps(
            {
                key: manifest[key]
