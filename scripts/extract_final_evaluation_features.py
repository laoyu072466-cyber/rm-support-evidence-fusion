...
MANIFEST_PATH = (
    PROJECT
    / "data/manifests/trajectory_features_final_eval_layer28_1p7b.json"
)

FILES = {'gsm_id_test': {'filename': 'gsm_id_test_mixed.jsonl',
                         'dataset': 'GSM8K',
                         'role': 'id_test_mixed'},
         'math_id_test': {'filename': 'math_id_test_mixed.jsonl',
                          'dataset': 'MATH',
                          'role': 'id_test_mixed'},
         'svamp_ood': {'filename': 'svamp_ood_mixed.jsonl',
                       'dataset': 'SVAMP',
                       'role': 'ood_mixed'}}
