...
CONFIG_PATH = (
    ROOT
    / "configs/fresh_math_2026_qwen3_8b_nonthinking_smoke.json"
)
PARTS_DIR = (
    ROOT
    / "outputs/fresh_math_2026/qwen3_8b_nonthinking_smoke_parts"
)
OUTPUT_PATH = (
    ROOT
...
MANIFEST_PATH = (
    ROOT
    / "data/manifests/"
    "fresh_math_2026_qwen3_8b_nonthinking_smoke.json"
)
...
def main():
    ...
    print("===== Qwen3-8B Non-Thinking 冒烟生成 =====")
    ...
    print()
    print("===== Track B Non-Thinking 冒烟完成 =====")
    print(
        json.dumps(
            {
                key: manifest[key]
